...
<body class="bg-dark">
    ...
    <main id="main">
        ...
        <div class="align-self-center w-100">
            ...
            <h4 class="text-white text-center"><b>Tenant Login | <a href="admin/">Administrator Login</a></b></h4>
            <div id="login-center" class="bg-dark row justify-content-center">
                <div class="card col-md-4">
                    <div class="card-body">
                        ...
                        <p></p>
                        <i style="text-align: center; color: gray;">New tenant?, please use the Login sent to you to
                            create password.</i>
                    </div>
                </div>
            </div>
