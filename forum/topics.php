			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Topic List</b>
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_topic">
						...
						<ul class="w-100 list-group" id="topic-list">
							...
							?>
								<li class="list-group-item mb-4">
									<div>
										<?php //if ($_SESSION['login_id'] == $row['user_id'] || $_row['house_id'] == 1) : 
										?>
										...
										<a href="index.php?page=../admin/view_forum&id=<?php echo $row['id'] ?>" class=" filter-text"><?php echo $row['title'] ?></a>
