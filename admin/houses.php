					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<select name="typez" id="" class="custom-select" required>
									<option>Duplex</option>
									<option>Single-Family Home</option>
									<option>Multiple-Family Home</option>
									<option>2-story house</option>
							...
							<div class="form-group">
								<label class="control-label">OutLet Types</label>
								<select name="outlet" id="" class="custom-select" required>
								...
								?>
									<tr>
										...
										<td class="">
											...
											<p><small>House Type: <b><?php echo $row['typez'] ?></b></small></p>
											<p><small>Description: <b><?php echo $row['description'] ?></b></small></p>
											<p><small>Price: <b><?php echo number_format($row['price'], 2) ?></b></small></p>
											<p><small>Outlet Type: <b><?php echo ($row['outlet']) ?></b></small></p>
										</td>
										<td class="text-center">
											<button class="btn btn-sm btn-primary edit_house" type="button" data-id="<?php echo $row['id'] ?>" data-house_no="<?php echo $row['house_no'] ?>" data-description="<?php echo $row['description'] ?>" data-typez="<?php echo $row['typez'] ?>" data-price="<?php echo $row['price'] ?>">Edit</button>
...
<script>
	...
	$('#manage-category').click(function() {
		uni_modal("New Property Categories(Types)", "categories.php", "large")
