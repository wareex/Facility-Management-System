...
<nav id="sidebar" class='mx-lt-5 bg-dark'>
	...
	<div class="sidebar-list">
		...
		<a href="index.php?page=agents" class="nav-item nav-invoices"><span class='icon-field'><i class="fa fa-file-invoice "></i></span> Service Agents</a>
		<?php if ($_SESSION['login_type'] == 1) : ?>
			<a href="index.php?page=../forum/chat_categories" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users "></i></span> Create Chat Tag</a>
