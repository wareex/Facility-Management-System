    ...
    <form action="" id="manage-tenant">
        ...
        <div class="form-group row">
            <div class="form-group">
                ...
                <input type="number" class="form-control text-right" name="no_of_occupant" value="<?php echo isset($no_of_occupant) ? $no_of_occupant : '' ?>" required="">
            </div>
            <div class="col-md-4">
                <label for="" class="control-label">Property Occupied</label>
                <select name="house_id" id="" class="custom-select select2">
                    <option value="<?php echo isset($house_id) ? $house_id : '' ?>"> <?php echo $house_id;
                                                                                        ?></option>
                </select>
            </div>
            <div class="col-md-4">
