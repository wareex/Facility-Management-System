                            ...
                            <div class="card border-dark">
                                <div class="card-body bg-dark">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                                <?php echo $conn->query("SELECT * FROM tenants where house_id != 1 ")->num_rows ?>
                                            </b></h4>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card border-success">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=../forum/topics" class="text-primary float-right">View Chats <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-dark">
                                <div class="card-body bg-dark">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"> <i class="fa fa-user-friends "></i></span>
                                        <h4><b>
                                                <?php echo $conn->query("SELECT * FROM agents where status = 0 ")->num_rows ?>
                                            </b></h4>
                                        <p><b>Available Agents</b></p>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="index.php?page=agents" class="text-primary float-right">View List <span class="fa fa-angle-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
